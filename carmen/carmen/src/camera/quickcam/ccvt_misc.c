...
/* 
 * $Log$
 * Revision 1.2  2006/04/06 00:30:09  stachnis
 * added the new header to all *.c *.h files
 *
 * Revision 1.1  2005/12/12 20:11:40  nickr
 * *** empty log message ***
 *
 * Revision 1.1  2005/07/22 02:41:34  nickr
 * Initial check-in of camera module
 *
 * Revision 1.1.1.1  2004/05/10 19:15:50  anrp
 * imported iPhilipsCamera
 *
