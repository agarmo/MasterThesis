...
There are a number of reference frames associated with this project. The global reference
frame are the NED frame (North, East, Down). This is defined as the tangential plane
defined where the object in question is, and defined to move with the object.

The other frame in this project is the local \emph{Body-frame}. This frame is defined
relative to the NED frame. Velocities and forces are usually defined in the body-frame. 

The last frame which is important is the \emph{Sensor-frames}. This is the frames which
the sensor output are defined. 
