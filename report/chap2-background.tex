...
\begin{itemize}
    ...
    \item ``Flying Pixelse'' occurs when a pixel in the camera oversees a region with
...
This is the article which I'm going to cite. \cite{sr3000} ***************should be moved to the sensor
specific section************

And this one \cite{time-of-flight-comp-graphics}. 
