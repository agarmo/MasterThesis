...
of points are called the \emph{consensus set} (CS). The algorithm terminates when the 
probability of generating a better consensus set drops below a certain threshold, i.e.
more points can be added to the consensus set.\cite{ransac-dummies}
